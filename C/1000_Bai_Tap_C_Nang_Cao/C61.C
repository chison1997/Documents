...
main()
{
        ...
        unsigned int k, KiemTra=1, SoTruoc=9,SoSau;
        unsigned long n,m;
        printf("n= ");scanf("%u",&n);
        ...
        if(KiemTra) printf("%ld co cac chu so giam dan tu trai sang phai \n",m);
        else printf("%ld khong co cac chu so giam dan tu trai sang phai \n",m);
